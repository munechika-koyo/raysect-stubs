...
from ...vector3d.function1d.base import Function1D as VectorFunction1D
from ...vector3d.function1d.base import MultiplyFunction1D as MultiplyVectorFunction1D
...
class Function1D(FloatFunction):
    ...
    @overload
    def __rmod__(self, a: float, /) -> ModuloScalarFunction1D: ...
    def __neg__(self) -> MultiplyScalar1D: ...
    @overload
    def __pow__(
        self,
        b: Callable[[float], float] | Function1D | float,
        c: Callable[[float], float] | Function1D | float,
        /,
    ...
    @overload
    def __rpow__(self, other: Callable[[float], float] | Function1D, modulo: None = None, /) -> PowFunction1D: ...
    @overload
    def __rpow__(self, other: float, modulo: None = None, /) -> PowScalarFunction1D: ...
    def __abs__(self) -> AbsFunction1D: ...
    @overload  # type: ignore[override]
    def __eq__(self, other: Callable[[float], float] | Function1D, /) -> EqualsFunction1D: ...  # pyrefly: ignore [bad-override]
    @overload
    def __eq__(self, other: float, /) -> EqualsScalar1D: ...
    @overload  # type: ignore[override]
    def __ne__(self, other: Callable[[float], float] | Function1D, /) -> NotEqualsFunction1D: ...  # pyrefly: ignore [bad-override]
    @overload
    def __ne__(self, other: float, /) -> NotEqualsScalar1D: ...
    @overload
    def __lt__(self, other: Callable[[float], float] | Function1D, /) -> LessThanFunction1D: ...
    @overload
    def __lt__(self, other: float, /) -> GreaterThanScalar1D: ...
    @overload
    def __le__(self, other: Callable[[float], float] | Function1D, /) -> LessEqualsFunction1D: ...
    @overload
    def __le__(self, other: float, /) -> GreaterEqualsScalar1D: ...
    @overload
    def __gt__(self, other: Callable[[float], float] | Function1D, /) -> GreaterThanFunction1D: ...
    @overload
    def __gt__(self, other: float, /) -> LessThanScalar1D: ...
    @overload
    def __ge__(self, other: Callable[[float], float] | Function1D, /) -> GreaterEqualsFunction1D: ...
    @overload
    def __ge__(self, other: float, /) -> LessEqualsScalar1D: ...
...
class AbsFunction1D(Function1D):
    """
    ...
    def __init__(self, function: float | Callable[[float], float] | Function1D) -> None: ...
