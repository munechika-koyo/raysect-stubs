...
class Blend3D(Function3D):
    ...
    def __init__(
        self,
        f1: Function3D | float | Callable[[float, float, float], float],
        f2: Function3D | float | Callable[[float, float, float], float],
        mask: Function3D | float | Callable[[float, float, float], float],
    ) -> None:
        """
